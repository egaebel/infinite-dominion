...
let useCORS = false; // flag to activate loading of external images via CORS helper function -> otherwise canvas is tainted and download button not working
...
function initCardImageGenerator() {
    console.log("initCardImageGenerator called");
    ...
    // This covers the type of image base, i.e. normal card, event, pile, etc.
    ...
    // This covers when some input field is changed, this will only happen on re-creation.
    ...
    // Pull in data from query strings and DOM input elements.
    ...
    // ADDED.
    document.getElementById("extra-redraw-element-in-index-html").onchange = () => {
        queueDraw();
    }
    document.getElementById("extra-redraw-element-for-picture-in-index-html").onchange = (event) => {
        onChangeExternalImage(5, event.type);
    }
}
